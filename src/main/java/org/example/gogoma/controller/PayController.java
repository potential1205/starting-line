...
public class PayController {
     ...
     */
    @PostMapping("/ready")
    @Operation(summary = "카카오페이 결제 준비", description = "판매품목 이름과 가격을 받아와 카카오페이 결제 tid와 리다이렉트 주소를 반환합니다.")
     ...
     */
    @PostMapping("/approve")
    @Operation(summary = "카카오페이 결제 승인", description = "tid와 pgToken을 받아와 결제를 승인하고 결제 정보를 반환합니다.")
